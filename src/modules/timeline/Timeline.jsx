  ...
  return (
    <section>
      <div className="flex items-center justify-between mb-3">
        <h2 className="text-h4 text-text-primary">Timeline</h2>
      ...
      {Object.keys(groups).length === 0 ? (
        <p className="text-caption text-text-tertiary py-8 text-center">No events match the current filters.</p>
      ) : (
